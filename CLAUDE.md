...
| `Sources/PeraperaApp/Resources/Words/` | A slice of JMdict for the reading drill and dictionary pictures, built by `tools/words/build.py`. **CC BY-SA 4.0**, not MIT — see the LICENCE beside it. |
